      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            The Reskilling
            <span className="bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent"> Crisis</span>
          </h2>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            AI disruption isn't coming—it's here. Organizations need rapid, cost-effective solutions for workforce adaptation.
          </p>
        </div>

        {/* Main stats grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          {/* Left side - AI Disruption Stat */}
          <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-3xl p-8 border border-red-100 relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-4">
                AI Disruption Requires Rapid Reskilling
              </h3>
              
              <div className="mb-6">
                <div className="text-5xl font-bold text-red-600 mb-2">44%</div>
                <p className="text-lg text-slate-700 leading-relaxed">
                  of worker's skills will be disrupted by AI within 5 years
                </p>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm text-slate-600">
                <span>Source:</span>
                <a 
                  href="https://www.weforum.org/stories/2025/04/new-skills-triad-and-future-of-work/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-red-600 hover:text-red-700 underline flex items-center gap-1 transition-colors"
                >
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 border border-green-100 relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 mb-6">
                <div>
                  <div className="text-4xl font-bold text-green-600 mb-1">70-92%</div>
                  <p className="text-base text-slate-700">cost savings</p>
                </div>
                <Separator className="bg-green-200" />
                <div>
                  <div className="text-4xl font-bold text-green-600 mb-1">218%</div>
                  <p className="text-base text-slate-700">higher income per employee</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm text-slate-600">
                <span>Source:</span>
                <a 
                  href="https://pierpoint.com/blog/upskilling-and-reskilling-economic-impact/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-green-600 hover:text-green-700 underline flex items-center gap-1 transition-colors"
                >
                  Pierpoint + Forbes
                  <ExternalLink className="w-3 h-3" />
                </a>
          ...
          <div className="inline-flex items-center gap-4 px-8 py-4 bg-gradient-to-r from-purple-100 to-blue-100 rounded-2xl border border-purple-200">
            ...
            <div className="text-left">
              ...
              <div className="text-lg font-semibold text-slate-900">
                Organizations need rapid, adaptive reskilling platforms—not traditional training
              </div>
            </div>
          </div>
        </div>
